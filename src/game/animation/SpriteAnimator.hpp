...
private:
    std::vector<std::unique_ptr<AnimationSequence>> anim_seq;
...
public:
    ...
    AnimationSequence* getAnimSequence(const size_t &sequence_id);
    void loadAnimSequence(AnimationSequence* sequence, std::string texture_location);
